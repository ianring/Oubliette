		...
		<div class="span5 offset3">
			<div class="tab-content">
				...
				<div class="tab-pane" id="hivepanel">
					...
					<p>Receive IP list updates from Oubliette's central blacklist.</p>
					
					<input type="button" class="btn" value="Join the Hive">
					
					<table style="width:100%">
						<thead>
						<tr>
							<th>IPs identified as:</th>
							<th>You pay:</th>
						</tr>
						</thead>
						<tbody>
