...
define("OUBLIETTE_UNBAN_CHANCES",3); // after being banned (and unbanned) this many times, the option to unban is denied.
...
define("OUBLIETTE_PENALTY_DURATION", 15); // penalty box timeout, in seconds.
